...
<body>
    <div class="container_12" style="background-color:#a3a8a6;">
        <div class="grid_12 header-repeat">
            <div id="branding" style="background-color: #484d4b;">
                <div class="floatleft logo">
                    <img src="img/lg2.png" alt="Logo" />
				</div>
				<div class="floatleft middle">
					<h1>LU Transport Tracking and Monitoring System (LU-T2MS)</h1>
        ...
        <div class="grid_12">
            <ul class="nav main" style="background-color: #484d4b;" >
        ...
        <div class="clear" style="background-color: #484d4b;">
        </div>
